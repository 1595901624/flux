...
Vxn 是一款基于 [mihomo](https://github.com/MetaCubeX/mihomo) 内核的轻量级 Windows 代理客户端，使用 WinUI 3 构建。
...
2. 编译并运行：
   ...
   或使用 Visual Studio 2022 打开 `Vxn.slnx`，按 <kbd>F5</kbd> 调试运行。

## 配置说明

Vxn 使用标准的 Clash 兼容 YAML 配置文件。可参考 [`sample-profile.yaml`](sample-profile.yaml) 了解节点、策略组和规则的最小配置示例。
